...
NSString *const RCTUIManagerFinishedFlushNotification = @"RCTUIManagerFinishedFlushNotification";
...
{
  [[RCTViewSnapshotter sharedInstance] snapshotSetChildren:containerTag reactTags:reactTags];
                  ...
                  props:(NSDictionary *)props)
{
  ...
  [[RCTViewSnapshotter sharedInstance] snapshotView:reactTag viewName:viewName rootTag:rootTag props:props];
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    ...
    if (view) {
      ...
      uiManager->_viewRegistry[reactTag] = view; // NOTE: this causes views to render, with layoutAndMount
...
- (void)flushUIBlocks
{
  ...
  if (previousPendingUIBlocks.count) {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
      ...
      RCT_PROFILE_END_EVENT(RCTProfileTagAlways, @"");
      [[NSNotificationCenter defaultCenter] postNotificationName:RCTUIManagerFinishedFlushNotification
                                                          object:self];
    });
  }
}
